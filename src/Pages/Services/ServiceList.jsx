...
function ServiceList() {
  return (
    <>
      <Toppages Title="Our Services" image={images.topimage} />
      <section className="wrapper !bg-[#ffffff]">
        <div className="container pt-[4.5rem] pb-14 xl:pt-24 lg:pt-24 md:pt-24 xl:pb-[4.5rem] lg:pb-[4.5rem] md:pb-[4.5rem]">
          <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[-50px] lg:!mb-10 xl:!mb-10 items-center">
                ...
                <div className="xl:w-5/12 lg:w-5/12 md:w-5/12 w-full flex-[0_0_auto] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] px-[15px] max-w-full xl:!ml-[8.33333333%] lg:!ml-[8.33333333%] md:!ml-[8.33333333%] !self-end mt-[25px]">
                  <div className="card !bg-[#fef3e4]">
                    <div className="card-body p-[40px]">
                      ...
                      <h4>24/7 Support</h4>
                      <p className="!mb-0">
                        Our team ensures efficient, timely issue through 24/7
                        customer support.
                      </p>
                    </div>
                  </div>
                ...
                <div className="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] px-[15px] max-w-full !self-end mt-[25px]">
                  <div className="card !bg-[#fae6e7]">
                    <div className="card-body p-[40px]">
                      ...
                      <p className="!mb-0">
                        We provide secure payment processing experiences.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] px-[15px] max-w-full !self-start mt-[25px]">
                  <div className="card !bg-[#e0e9fa]">
                    <div className="card-body p-[40px]">
                      ...
                      <p className="!mb-0">
                        We analyze market trends, customer preferences, and
                        competitor strategies to inform decisions.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] mt-[50px] max-w-full">
              ...
              <p>
                We believe in providing solutions that deliver measurable
                results. Whether youre looking for efficiency, quality, or
                innovation, our services are designed to address your unique
                challenges. Our experienced team works with you every step of
                the way to ensure your goals are met and exceeded.
              </p>
            </div>
          </div>
        </div>
