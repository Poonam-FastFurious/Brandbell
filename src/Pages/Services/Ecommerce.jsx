...
import image5 from "../../assets/Newimages/3d5.jpg";
        ...
        <div className="container  pb-16 xl:pb-20 lg:pb-20 md:pb-20 !text-center">
          <div className="flex flex-wrap mx-[-15px]">
            <div className="md:w-10/12 xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:!ml-[16.66666667%] lg:!ml-[16.66666667%] md:!ml-[8.33333333%]">
              ...
              <p className=" mb-12">
                We are able to develop any unique or standard features required
                for seamless client interactions. Regardless of your technology
                or business strategy, our team has the resources to complete the
                task. Fast, dependable, and secure eCommerce online services are
              ...
              <div className="md:w-6/12 lg:w-6/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] max-w-full mt-[25px]">
                <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div className="card-body flex-[1_1_auto] p-[40px]">
                    ...
                    <p className="!mb-2">
                    Enhance your operational efficiency and user experience with expert guidance on business strategy, technology, and operations. <br /> <br />
              ...
              <div className="md:w-6/12 lg:w-6/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] max-w-full mt-[25px]">
                <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div className="card-body flex-[1_1_auto] p-[40px]">
                    ...
                    <h4>E-commerce Implementation</h4>
                    <p className="!mb-2">
                    Seamlessly integrate cloud platforms, payment gateways, POS systems, and CRMs into your eCommerce stores and mobile apps for a smooth and efficient experience.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="md:w-6/12 lg:w-6/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] max-w-full mt-[25px]">
                <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div className="card-body flex-[1_1_auto] p-[40px]">
                    ...
                    <p className="!mb-2">
                    Stay ahead of the competition with our expert eCommerce marketing team, specializing in SEO, PPC, and social media strategies to boost your brand’s growth.
                    </p>
                  </div>
                </div>
              </div>
              <div className="md:w-6/12 lg:w-6/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] max-w-full mt-[25px]">
                <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div className="card-body flex-[1_1_auto] p-[40px]">
                    ...
                    <p className="!mb-2">
                    Our e-commerce web designers create responsive designs that ensure a seamless shopping experience, making your online store look stunning on both desktop and mobile devices
                    </p>
                  </div>
                </div>
              </div>
              <div className="md:w-6/12 lg:w-6/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] max-w-full mt-[25px]">
                <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div className="card-body flex-[1_1_auto] p-[40px]">
                    ...
                    <p className="!mb-2">
                    Our team keeps your eCommerce platform running smoothly and securely with proactive support and strategic updates, ensuring it evolves with your business needs.
<br /> <br />
                    </p>
                  </div>
                </div>
              ...
              <div className="md:w-6/12 lg:w-6/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] xl:px-[12.5px] lg:px-[12.5px] md:px-[12.5px] max-w-full mt-[25px]">
                <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div className="card-body flex-[1_1_auto] p-[40px]">
                    ...
                    <p className="!mb-2">
                    Our e-commerce platforms ensure seamless operations. From product listings to inventory tracking, we optimize every aspect, boosting performance, customer satisfaction, 
and revenue growth.
        ...
        <div className="container pt-20 ">
          ...
          <div className="flex flex-wrap mx-[-7.5px] mt-[-50px] xl:mt-0 lg:mt-0  items-center">
            ...
            <div className="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] max-w-full mr-auto px-[7.5px] mt-[50px] xl:mt-0 lg:mt-0">
              ...
              <p className="!mb-6">
                At Brandbell, we simplify your business journey by providing
                innovative solutions tailored to your needs. From strategic
                planning to seamless execution, our expert team ensures
                efficiency and growth. Focus on what you do best while we handle
                the rest with precision and excellence. Let us take your
                business to new heights with our reliable and results-driven
                approach.
              </p>
