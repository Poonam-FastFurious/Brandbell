...
function AboutUs() {
  return (
    <>
      <Toppages Title="About Us" image={images.Toppageaboutimage} />
          ...
          <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[-50px] !mb-[4.5rem] xl:!mb-[8rem] lg:!mb-[8rem] md:!mb-[8rem] items-center">
            ...
            <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] max-w-full mt-[50px]">
              ...
              <h3 className="text-[calc(1.305rem_+_0.66vw)] font-bold xl:text-[1.8rem] !leading-[1.3] mb-4">
                Expert in Global Complex <br /> Business Solution
              </h3>
              <p className="!mb-5">
                ...
                over all else. Real business impact that improves brand
                awareness, sales, and visibility. Each and every time.
              </p>
                ...
                <div className="xl:w-6/12 w-full flex-[0_0_auto] px-[15px] max-w-full mt-[15px]">
                  <ul className="pl-0 list-none bullet-bg bullet-soft-leaf !mb-0">
                    <li className="relative pl-6">
                      ...
                      <span>
                        We provide integrated digital and advertising solutions
                    ...
                    <li className="mt-3 relative pl-6">
                      ...
                      <span>
                        Focused on driving real results that enhance brand
                ...
                <div className="xl:w-6/12 w-full flex-[0_0_auto] px-[15px] max-w-full mt-[15px]">
                  <ul className="pl-0 list-none bullet-bg bullet-soft-leaf !mb-0">
                    <li className="relative pl-6">
                      ...
                      <span>
                        We help improve your brands presence and growth with
                        every strategy we implement
                      </span>
                    </li>
                    <li className="mt-3 relative pl-6">
                      <span>
                      ...
                      <span>
                        {" "}
                        Our solutions deliver measurable, impactful results for
            ...
            <div className="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] mt-[50px] max-w-full">
              ...
              <div className="flex flex-row mb-4">
                ...
                <div>
                  ...
                  <p className="!mb-1">
                    We understand your vision, define goals, and ensure project
              ...
              <div className="flex flex-row mb-4">
                ...
                <div>
                  ...
                  <p className="!mb-1">
                    We analyze data, trends, and consumer behavior to validate
              ...
              <div className="flex flex-row">
                ...
                <div>
                  ...
                  <p className="!mb-0">
                    We refine, test, and perfect your product for a successful
                    launch.
                  </p>
                </div>
              </div>
