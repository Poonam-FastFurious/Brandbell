...
function Whoarewe() {
  return (
    <>
      <section
        className="wrapper !bg-[#ffffff]  angled lower-end relative after:bottom-[-4rem] after:border-l-transparent after:border-r-[100vw] after:border-b-[4rem] after:border-[#fefefe] after:content-[''] after:block after:absolute after:z-0 after:!border-y-transparent after:border-0 after:border-solid after:right-0
    "
      >
        <div className="container py-[4.5rem] xl:!py-24 lg:!py-24 md:!py-24">
          <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[-50px] !mb-[4.5rem] xl:!mb-[7rem] lg:!mb-[7rem] md:!mb-[7rem] items-center">
            ...
            <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] mt-[50px] max-w-full">
              ...
              <p className="!mb-6">
                At Brandbell, we are a team of passionate and dedicated
                individuals who share a common goal to make a positive impact in
                the lives of our customers and the community. Our company was
                ...
                <div className="xl:w-6/12 w-full flex-[0_0_auto] mt-[15px] xl:px-[20px] px-[15px] max-w-full">
                  <ul className="pl-0 list-none bullet-bg bullet-soft-primary  !mb-0">
                    <li className="relative pl-6">
                      ...
                      <span>Skilled and experienced profession</span>
                    </li>
                    <li className="relative pl-6 mt-3">
                      <span>
                        <i className="uil uil-check w-4 h-4 text-[0.8rem] leading-none tracking-[normal] !text-center flex justify-center items-center bg-[#dce7f9] text-[#3f78e0] rounded-[100%] top-[0.2rem] before:content-['\e9dd'] before:align-middle before:table-cell absolute left-0"></i>
                      ...
                      <span>
                        Timely project delivery with a focus on client
                        satisfaction.
                      </span>
                    </li>
                  </ul>
          ...
          <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[-50px] items-center">
              ...
              <div className="card xl:!mr-6 lg:!mr-6">
                <div className="card-body p-6">
                  <div className="flex flex-row">
                    ...
                    <div>
                      <h5 className="!mb-1">Collect Ideas</h5>
                      <p className="!mb-0">
                        We understand your vision, define goals, and ensure
                        project alignment through collaboration
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="card-body p-6">
                  <div className="flex flex-row">
                    ...
                    <div>
                      ...
                      <p className="!mb-0">
                        We analyze data, trends, and consumer behavior to
              ...
              <div className="card mt-6 xl:mx-6 lg:mx-6">
                <div className="card-body p-6">
                  <div className="flex flex-row">
                    ...
                    <div>
                      <h5 className="!mb-1">Finalize Product</h5>
                      <p className="!mb-0">
                        We refine, test, and perfect your product for a
                        successful launch.
                      </p>
                    </div>
                  </div>
            ...
            <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] mt-[50px] max-w-full">
              ...
              <p className="lead !text-[1.05rem] !leading-[1.6] font-medium xl:pr-5 lg:pr-5">
                At Brandbell, we follow a streamlined process to ensure that
                your business projects are executed with precision and
                efficiency. Our approach focuses on delivering high-quality
                solutions, from ideation to the final product, all tailored to
                your needs.
              </p>
              <p>
                IT infrastructure solutions, or system integrations, we follow a
                structured approach that ensures your needs are met with
                precision and efficiency. Our team of experienced professionals
                collaborates with you throughout every phase,
              </p>
              <p className="!mb-6">
                Understanding your challenges to ongoing support, guaranteeing a
                smooth and successful implementation. Heres a step-by-step
                breakdown of how we work with you.
              </p>
            </div>
          </div>
        </div>
